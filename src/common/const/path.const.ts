...
// 외부에서 접근 가능한 파일들을 모아 둔 폴더 이름
export const PUBLIC_FOLDER_NAME = 'public' as const;
// 포스트 이미지들을 저장할 폴더 이름
export const POSTS_FOLDER_NAME = 'posts' as const;
// 임시 폴더 이름
export const TEMP_FOLDER_NAME = 'temp' as const;
