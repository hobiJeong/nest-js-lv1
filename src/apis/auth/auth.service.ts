...
import { RegisterUserDto } from '@src/apis/auth/dto/register-user.dto';
...
export class AuthService {
   ...
   *    Basic 토큰은 '이메일:비밀번호'를 Base64로 인코딩한 헤더이다.
  ...
  async authenticateWitEmailAndPassword(
